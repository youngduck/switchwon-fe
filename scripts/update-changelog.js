 ...
 *
 * 사용법:
 *   node scripts/update-changelog.js "refactor: 컴포넌트를 yd-ui Table로 교체"
 *
...
/**
 * 커밋 메시지에서 타입과 내용 추출
 * 예: "refactor: 컴포넌트를 yd-ui Table로 교체"
 * -> { type: "refactor", message: "컴포넌트를 yd-ui Table로 교체" }
 */
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.log("\n예시:");
    console.log('  node scripts/update-changelog.js "refactor: 컴포넌트를 yd-ui Table로 교체"');
    process.exit(1);
  }
